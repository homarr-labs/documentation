...
If you haven't already mounted an icons folder, please go back to the [installation docs](/docs/getting-started/introduction/installation) and follow the instructions for mounting the icons folder.
