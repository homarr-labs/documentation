...
The calendar Widget will use [Integrations](/docs/management/integrations/index) to display upcoming content.
It can display content from [Sonarr](/docs/management/integrations/servarr#sonarr), [Radarr](/docs/management/integrations/servarr#radarr), [Lidarr](/docs/management/integrations/servarr#lidarr) and [Readarr](/docs/management/integrations/servarr#readarr).

---

## Adding the widget
Please check out our documentation on [how to add a widget](/docs/getting-started/introduction/after-the-installation#adding-widgets).
...
It filters through all images of the release and takes the first match, that is of the cover-type ``poster``.
...
Check out our documentation on [editing tiles](/docs/getting-started/introduction/after-the-installation#organizing-and-re-arranging-your-dashboard).
