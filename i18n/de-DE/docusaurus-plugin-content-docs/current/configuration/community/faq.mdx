...
Yes, Homarr is compatible with the architecture of the Raspberry Pi. Have a look in our <a href="/docs/getting-started/introduction/installation">installation guide</a> on how to do so.
...
Yes, check out our guide on <a href="/docs/configuration/customizations/icons">how to add your custom icons</a>.
...
If you still want to add a widget, please consider to contribute it directly to Homarr. For that, basic programming skills are required. Our [Developer Guides](/docs/configuration/community/developer-guides) explain this even more detailed.
...
Make sure to enable the "allow anonymouse access" [option in the settings](/docs/configuration/customizations/board-customization#access), if you want to allow people without an account to be able to see your dashboard (not edit)
...
Yes, go <a href="/docs/configuration/community/get-in-touch">here</a> to get with us in touch.

<hr/>

:::tip

Haven't found the solution to your problem / question? We are eager to help you on [our Discord](/docs/configuration/community/get-in-touch#discord) or in a [GitHub Issue](https://github.com/ajnart/homarr/issues/new/choose).
