...
If you're looking for the [installation guide](/docs/getting-started/introduction/installation),
...
using [our community-driven translation program](/docs/configuration/community/translations).
