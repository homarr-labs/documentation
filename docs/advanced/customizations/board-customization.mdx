...
You can also use a video as background. Just add a URL or a path to the input field. `.mp4`, `.webm` and `.ogg` files are supported.
Make sure your browser supports the video format you are using. You can find a list of supported formats [here](https://en.wikipedia.org/wiki/HTML5_video#Browser_support).
