...
In homarr, apps are the key concept, an app is a tile on your dashboard that links to an external application, it can be connected via an integration, for more information about the terms we will use please take a look at the [glossary](/docs/getting-started/glossary).
