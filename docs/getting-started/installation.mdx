...
### Troubleshooting
Having trouble installing Homarr on your system? Check out our [FAQ](/docs/community/faq). If you are still running into issues, please contact us in our [Discord server](https://discord.com/invite/aCsmEV5RgA).
