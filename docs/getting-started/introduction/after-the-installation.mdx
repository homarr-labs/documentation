...
In homarr, apps are the key concept, an app is a tile on your dashboard that links to an external application, it can be connected via an integration, for more information about the terms we will use please take a look at the [glossary](/docs/getting-started/introduction/glossary).
...
Another popup will appear, where you can enter the details of your app. You can also [choose an icon](/docs/configuration/customizations/icons) for your app:
...
From the [glossary](/docs/getting-started/introduction/glossary)
:::
