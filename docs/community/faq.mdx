...
If you still want to add a widget, please consider to contribute it directly to Homarr. For that, basic programming skills are required. Our [Developer Guides](/docs/development/getting-started) explain this even more detailed.
...
Make sure to enable the "allow anonymous access" [option in the settings](/docs/advanced/customizations/board-customization#access), if you want to allow people without an account to be able to see your dashboard (not edit)
