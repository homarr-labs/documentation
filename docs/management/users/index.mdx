...
Homarr supports [single sign on for easier and seamless authentication](/docs/advanced/sso) (e.g. Authelia).
...
// TODO: what happens if user is in multiple groups with conflicting permissions?

By default, a group called "admin" will be generated where the first user will be placed.
...
// TODO: describe group ownership. What does it do?
