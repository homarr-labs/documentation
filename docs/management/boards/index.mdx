...
See [board customizations](/docs/advanced/customizations/board-customization#custom-css) for more information.
...
Groups that have high permissions (e.g. admin group) will be shown as "inherited".
They are permitted implicitly due to their permissions.

// TODO: @meierschlumpf is this correct?
...
The home dashboard is the dashboard, that will be shown at the root path of Homarr or if no board name was passed in the URL.
