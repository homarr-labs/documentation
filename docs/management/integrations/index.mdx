...
- [Jellyfin (and Emby)](https://homarr.dev/docs/management/integrations/media-server#jellyfin-and-emby)
...
🗂️ Indexer Manager
- [Prowlarr](https://homarr.dev/docs/management/integrations/indexer-manager#prowlarr)
Other integrations
