...
They may require additional configuration in or outside Homarr.
An integration cannot be added by itself.
You must configure an app to a specific integration.
Most integration will then fill widgets with data or add functionality to
other parts of Homarr.
