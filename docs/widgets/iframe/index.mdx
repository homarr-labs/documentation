...
## homarr-iframes
The project [homarr-iframes](https://github.com/diogovalentte/homarr-iframes) has iframes designed to be used with Homarr. These iframes offer a minimalist view of other systems, like viewing your tasks from [Vikunja](https://github.com/go-vikunja/vikunja) or bookmarks from [Linkwarden](https://github.com/linkwarden/linkwarden).

![](./homarr-iframes-example.webp)

The iframes have options for configuration, like selecting the iframe theme and limit, and other options specific to each iframe.
