...
<div className='flex gap-1'>
  <div className='flex flex-col gap-1'>
    <img src={network} alt="system-resources-widget network-only" width={256 + 4} height={128} />
    <div className='flex gap-1'>
      <img src={cpu} alt="system-resources-widget cpu-only" width={128} height={128} />
      <img src={memory} alt="system-resources-widget memory-only" width={128} height={128} />
    </div>
  </div>
  <img src={cpuAndMemory} alt="system-resources-widget cpu-and-memory" width={256 + 4} height={256 + 4} />
</div>
