...
It can display content from [Sonarr](/docs/integrations/servarr#sonarr), [Radarr](/docs/integrations/servarr#radarr), [Lidarr](/docs/integrations/servarr#lidarr) and [Readarr](/docs/integrations/servarr#readarr).
