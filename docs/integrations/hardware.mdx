...
- [System Heath Monitoring](/docs/widgets/health-monitoring)
...
12. Click Add -> API Token Permission
    ...
    * Role: PVE Auditor
    * Propagate: Checked
13. Copy the Secret that is shown in Step 12 because it is only shown once

Using the User, Token ID, and Secret created above you need to format your API token as follows:

```
PVEAPIToken=<User>@pam!<Token ID>=<Secret>
```
...
```
PVEAPIToken=api@pam!homarr=eef235db-f891-4327-b84e-32bd48b7d0fd
```
