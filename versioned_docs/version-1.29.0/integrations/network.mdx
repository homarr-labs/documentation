...
## Unifi Controller
The Unifi Controller integration enables you to see basic stats with the help of the [Network Controller widget](/docs/1.29.0/widgets/network-controller).
It is created to support the normal and pro variants of the Unifi Controller.
