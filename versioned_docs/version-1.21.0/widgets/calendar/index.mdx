...
It can display content from [Sonarr](/docs/1.21.0/integrations/servarr#sonarr),
[Radarr](/docs/1.21.0/integrations/servarr#radarr),
[Lidarr](/docs/1.21.0/integrations/servarr#lidarr) and
[Readarr](/docs/1.21.0/integrations/servarr#readarr).
