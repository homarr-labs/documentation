...
| --------------------- | ---------------------------------------------------------------- | -------- | ------------- |
| Show only currently playing | If true only shows sessions that are currently playing media. Otherwise shows all sessions (exluding the connected Homarr Session) | yes / no | yes           |


:::warning
Plex will always show only currently playing sessions
:::
