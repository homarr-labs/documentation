...
| Custom time format   | You can define a custom time format.                                                                                           | Use the [ISO 8601](https://day.js.org/docs/1.10.0/en/display/format#list-of-all-available-formats) format for time | - |
