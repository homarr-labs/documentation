...
The calendar Widget will use [Integrations](/docs/1.10.0/category/integrations) to display upcoming content.
It can display content from [Sonarr](/docs/1.10.0/integrations/servarr#sonarr),
[Radarr](/docs/1.10.0/integrations/servarr#radarr),
[Lidarr](/docs/1.10.0/integrations/servarr#lidarr) and
[Readarr](/docs/1.10.0/integrations/servarr#readarr).
