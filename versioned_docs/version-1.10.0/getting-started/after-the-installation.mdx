...
incorrect or read-only. Read [our installation instructions](/docs/1.10.0/getting-started/installation/docker) again to fix this issue.
...
Public boards are also accessible for users, that are not logged in ([see access control for boards](/docs/1.10.0/management/boards/#access-control)).
...
Sometimes invalid configurations, firewalls and other mistakes can lead to connectivity problems - [follow this guide here](/docs/1.10.0/management/integrations/#troubleshooting-connection) if you experience issues.
...
- Choose from our beautiful and interactive [widgets](/docs/1.10.0/category/widgets)
- See [all supported integrations](/docs/1.10.0/category/integrations)
