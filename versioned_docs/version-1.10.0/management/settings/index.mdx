...
A full list of the collected data by default can be found here: https://umami.is/docs/1.10.0/metric-definitions.
...
The user can search them directly on Google.
